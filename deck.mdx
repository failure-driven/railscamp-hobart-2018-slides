...
yeah! nah! bringing developers up to speed with our pairing practices, test
...
Wrong again, to write good software you actually need to plan and architect a
...
Well at least we spread the message of Outside in Multi layer Behaviour Driven
Development and pairing

**Selena**

I think that we did and we had a lot of great conversations around how we do
testing and pairing and how that compares to everyone else. Not everyone got
onboard though, we are still hiring remember!

Also everyone at Rails Camp 24 Hobart Woodfield wrote some code that is
committed on github! Win!
